...
---
# pycast Flask Application

Awesome pycast created by 
...
```bash
git clone https://github.com//pycast pycast
cd pycast
make install
```
...
```bash
pycast create-db   # run once
pycast populate-db  # run once (optional)
pycast add-user -u admin -p 1234  # ads a user
pycast run
```
